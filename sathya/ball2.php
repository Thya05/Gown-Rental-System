...
<head>
    ...
    <title>Ball Collection - S&V Gown Rental</title>
...
<body class="font-sans bg-gray-50">
    ...
    <section class="relative min-h-[70vh] flex items-center justify-center bg-gradient-to-br from-rose-100 via-pink-100 to-violet-100 overflow-hidden">
        ...
        <div class="relative text-center px-4 pt-20">
            <h1 class="text-5xl font-bold text-gray-800 mb-6 leading-tight">Ball Collection</h1>
            <p class="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">Discover your dream ball dress from our exquisite collection.</p>
...
<section id="collection" class="py-24 bg-white">
    <div class="max-w-7xl mx-auto px-4">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
            <?php
            $ball_dresses = [
                ['id' => 1, 'name' => 'Ball Gown 1', 'price' => 1000, 'image' => 'img/ballgown1.jpeg'],
                ['id' => 2, 'name' => 'Ball Gown 2', 'price' => 1000, 'image' => 'img/ballgown2.jpeg'],
                ['id' => 3, 'name' => 'Ball Gown 3', 'price' => 500, 'image' => 'img/ballgown3.jpeg'],
                ['id' => 4, 'name' => 'Ball Gown 4', 'price' => 500, 'image' => 'img/ballgown4.jpeg'],
                ['id' => 5, 'name' => 'Ball Gown 5', 'price' => 500, 'image' => 'img/ballgown5.jpeg'],
                ['id' => 6, 'name' => 'Ball Gown 6', 'price' => 500, 'image' => 'img/ballgown6.jpeg'],
                ['id' => 7, 'name' => 'Ball Gown 7', 'price' => 500, 'image' => 'img/ballgown7.jpeg'],
                ['id' => 8, 'name' => 'Ball Gown 8', 'price' => 500, 'image' => 'img/ballgown8.jpeg'],
                ['id' => 9, 'name' => 'Ball Gown 9', 'price' => 500, 'image' => 'img/ballgown9.jpeg'],
                ['id' => 10, 'name' => 'Ball Gown 10', 'price' => 500, 'image' => 'img/ballgown10.jpeg'],
                ['id' => 11, 'name' => 'Ball Gown 11', 'price' => 500, 'image' => 'img/ballgown11.jpeg'],
                ['id' => 12, 'name' => 'Ball Gown 12', 'price' => 500, 'image' => 'img/ballgown12.jpeg'],
                ['id' => 13, 'name' => 'Ball Gown 13', 'price' => 500, 'image' => 'img/ballgown13.jpeg'],
                ['id' => 14, 'name' => 'Ball Gown 14', 'price' => 500, 'image' => 'img/ballgown14.jpeg'],
                ['id' => 15, 'name' => 'Ball Gown 15', 'price' => 500, 'image' => 'img/ballgown15.jpeg'],
                ['id' => 16, 'name' => 'Ball Gown 16', 'price' => 500, 'image' => 'img/ballgown16.jpeg'],
                ['id' => 17, 'name' => 'Ball Gown 17', 'price' => 500, 'image' => 'img/ballgown17.jpeg'],
                ['id' => 18, 'name' => 'Ball Gown 18', 'price' => 500, 'image' => 'img/ballgown18.jpeg'],
                ['id' => 19, 'name' => 'Ball Gown 19', 'price' => 500, 'image' => 'img/ballgown19.jpeg'],
            ];
            foreach ($ball_dresses as $index => $dress) {
                ...
                echo '<img src="' . $dress['image'] . '" alt="' . $dress['name'] . '" class="w-full h-72 object-cover">';
                ...
                echo '</div>';
                echo '</div>';
                echo '<div class="p-6 flex justify-between items-center">';
                if(isset($_SESSION['user_id'])) {
                    echo '<form action="cart.php" method="POST" class="flex-1 mr-2">';
                    echo '<input type="hidden" name="dress_id" value="' . $dress['id'] . '">';
                    echo '<input type="hidden" name="dress_name" value="' . $dress['name'] . '">';
                    echo '<input type="hidden" name="dress_price" value="' . $dress['price'] . '">';
                    echo '<button type="submit" class="w-full bg-gradient-to-r from-rose-400 to-pink-500 text-white px-6 py-3 rounded-full hover:shadow-lg hover:scale-105 transition-all duration-300">';
                    echo 'Add to Cart';
                    echo '</button>';
                    echo '</form>';
                    echo '<a href="booking.php" class="bg-gray-100 text-gray-800 px-6 py-3 rounded-full hover:bg-gray-200 transition-all duration-300">';
                    echo 'Book Now';
                    echo '</a>';
                } else {
                    echo '<a href="login.php" class="w-full bg-gradient-to-r from-rose-400 to-pink-500 text-white px-6 py-3 rounded-full text-center hover:shadow-lg hover:scale-105 transition-all duration-300">';
                    echo 'Login to Book';
                    echo '</a>';
                }
                echo '</div>';
    ...
    <div class="max-w-7xl mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div class="text-center">
                ...
                <p class="text-gray-600 text-sm">Explore our ball dress collection</p>
            </div>
            <div class="text-center">
