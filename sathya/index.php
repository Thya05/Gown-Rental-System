...
The Best List of Positive Review Response Examples - Usersnap',
    ...
    <section class="py-20 bg-gradient-to-r from-purple-500 to-pink-400 text-white text-center">
        ...
        <a href="login.php" class="mt-6 inline-block bg-white text-indigo-600 px-6 py-3 rounded-lg font-bold shadow-lg hover:scale-105 transition-transform">
            Book Appointment
        </a>
    </section>
