    ...
    <head>
        ...
        <title>Wedding Collection - S&V Gown Rental</title>
    ...
    <body class="font-sans bg-gray-50">
        ...
        <section class="relative min-h-[70vh] flex items-center justify-center bg-gradient-to-br from-rose-100 via-pink-100 to-violet-100 overflow-hidden">
            ...
            <div class="relative text-center px-4 pt-20">
                <h1 class="text-5xl font-bold text-gray-800 mb-6 leading-tight">Wedding Collection</h1>
                <p class="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">Discover your dream wedding dress from our exquisite collection.</p>
    ...
    <section id="collection" class="py-24 bg-white">
        <div class="max-w-7xl mx-auto px-4">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
                <?php
                $wedding_dresses = [
                    ['id' => 1, 'name' => 'Wedding Gown 1', 'price' => 1000, 'image' => 'img/wedding1.jpeg'],
                    ['id' => 2, 'name' => 'Wedding Gown 2', 'price' => 1000, 'image' => 'img/wedding2.jpeg'],
                    ['id' => 3, 'name' => 'Wedding Gown 3', 'price' => 500, 'image' => 'img/wedding3.jpeg'],
                    ['id' => 4, 'name' => 'Wedding Gown 4', 'price' => 500, 'image' => 'img/wedding4.jpeg'],
                    ['id' => 5, 'name' => 'Wedding Gown 5', 'price' => 500, 'image' => 'img/wedding5.jpeg'],
                    ['id' => 6, 'name' => 'Wedding Gown 6', 'price' => 500, 'image' => 'img/wedding6.jpeg'],
                    ['id' => 7, 'name' => 'Wedding Gown 7', 'price' => 500, 'image' => 'img/wedding7.jpeg'],
                ];
                    foreach ($wedding_dresses as $index => $dress) {
