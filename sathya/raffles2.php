...
<head>
    ...
    <title>Raffles Collection - S&V Gown Rental</title>
...
<body class="font-sans bg-gray-50">
    ...
    <section class="relative min-h-[70vh] flex items-center justify-center bg-gradient-to-br from-rose-100 via-pink-100 to-violet-100 overflow-hidden">
        ...
        <div class="relative text-center px-4 pt-20">
            <h1 class="text-5xl font-bold text-gray-800 mb-6 leading-tight">Raffles Collection</h1>
            <p class="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">Discover your dream raffle dress from our exquisite collection.</p>
...
<section id="collection" class="py-24 bg-white">
    <div class="max-w-7xl mx-auto px-4">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
            <?php
            $raffles_dresses = [
                ['id' => 1, 'name' => 'Raffle Gown 1', 'price' => 1000, 'image' => 'img/raffles1.jpeg'],
                ['id' => 2, 'name' => 'Raffle Gown 2', 'price' => 1000, 'image' => 'img/raffles2.jpeg'],
                ['id' => 3, 'name' => 'Raffle Gown 3', 'price' => 500, 'image' => 'img/raffles3.jpeg'],
                ['id' => 4, 'name' => 'Raffle Gown 4', 'price' => 500, 'image' => 'img/raffles4.jpeg'],
                ['id' => 5, 'name' => 'Raffle Gown 5', 'price' => 500, 'image' => 'img/raffles5.jpeg'],
                ['id' => 6, 'name' => 'Raffle Gown 6', 'price' => 500, 'image' => 'img/raffles6.jpeg'],
                ['id' => 7, 'name' => 'Raffle Gown 7', 'price' => 500, 'image' => 'img/raffles7.jpeg'],
            ];
            foreach ($raffles_dresses as $index => $dress) {
